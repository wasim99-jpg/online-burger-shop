<%-- 
    Document   : burgerwagyu
    Created on : Jan 17, 2022, 10:03:01 AM
    Author     : admin
--%>
...
<html>
    ...
    <head>
        ...
        <title>Burgerwagyu - Burgermbira</title>
    ...
    <body class="text-body">
        ...
        <c:set var="burgerid" value="<%=request.getParameter("burgerid")%>"/>
        ...
        <form action="cartInsert.jsp" method="post" >
            ...
            <div class="container" style="margin-bottom: 128px;margin-top: 151px;">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-12"><img class="img-thumbnail img-fluid center-block" src="assets/img/menu/burgerwagyu.jpg"></div>
                        </div>
                    </div>

                    <div class="col-md-5">
                        <h1>Burger wagyu</h1>
                        <p style="margin-bottom: 176px;">1 Paipsi cup (Large)<br>1 bowl of french fries (Large)<br>1 Burger Wagyu</p>
                        <h2 class="text-center text-success">RM 69.00</h2>
                        <div class="quanity-cart-row clearfix">
                            ...
                            <div class="add-to-cart"  class="input-group" align="center">
                                <button class="btn btn-primary" type="button">
                                    ...
                                    <input type="hidden" name="burgerid" value="B001"/>
                                    <input type="hidden" name="picture" value="assets/img/menu/burgerwagyu.jpg"/>
