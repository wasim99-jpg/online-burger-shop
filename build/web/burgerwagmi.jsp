<%-- 
    Document   : burgerwagmi
    Created on : Jan 17, 2022, 10:02:31 AM
    Author     : admin
--%>
...
<html>
    ...
    <head>
        ...
        <title>Burgerwagmi - Burgermbira</title>
        ...
        <form action="cartInsert.jsp" method="post" >
            ...
            <div class="container" style="margin-bottom: 128px;margin-top: 151px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <h1>Burger WAGMI</h1>
                        <p style="margin-bottom: 176px;">1 Paipsi cup (Large)<br>1 bowl of french fries (Large)<br>1 Burger Wagmi</p>
                        <h2 class="text-center text-success">RM 42.00</h2>
                        <div class="quanity-cart-row clearfix">
                            ...
                            <div class="add-to-cart"  class="input-group" align="center">
                                <button class="btn btn-primary" type="button">
                                    ...
                                    <input type="hidden" name="burgerid" value="B002"/>
                                    <input type="hidden" name="picture" value="assets/img/menu/burgerwagmi.jpg"/>
