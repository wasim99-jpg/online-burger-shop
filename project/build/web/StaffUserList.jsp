<%-- 
    ...
    Created on : Jan 20, 2022, 10:54:49 PM
    Author     : deskt
--%>
...
<html>
    ...
    <body class="text-body">
        ...
        <br><br><br><br><br><br>
        <!-- Feature -->
        <h1 class="text-center">CUSTOMERS LIST</h1><center>
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col" class="border-0 bg-light">
                                            <div class="p-2 px-3 text-uppercase">IC</div>
                                        </th>
                                        <th scope="col" class="border-0 bg-light">
                                            <div class="py-2 text-uppercase">EMAIL</div>
                                        </th>
                                        <th scope="col" class="border-0 bg-light">
                                            <div class="py-2 text-uppercase">PHONE NUM</div>
                                        </th>
                                        <th scope="col" class="border-0 bg-light">
                                            ...
                                            <th scope="row" class="border-0">
                                                <div class="p-2">
                                                    ...
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"><a href="#" class="text-dark d-inline-block align-middle"><c:out value="${row.USERIC}"/></a></h5>
                                                    </div>
                                                </div> 
                                            </th>
                                            <td class="border-0 align-middle"><strong><c:out value="${row.EMAIL}"/></strong></td> 
                                            <td class="border-0 align-middle"><strong><c:out value="${row.PHONENUM}"/></strong></td>  
                                            <td class="border-0 align-middle"><strong><c:out value="${row.ADDRESS_1}"/></strong></td>
                                            <td class="border-0 align-middle"><strong><c:out value="${row.ADDRESS_2}"/></strong></td> 
                                            <td class="remove"><a href="deleteUser.jsp?userID=<c:out value="${row.USERIC}"/>"><button type="button" class="btn btn-primary"type="submit">Delete</button></a></td>
        ...
        <br><br>
        <!-- Feature -->
        <h1 class="text-center">STAFF LIST</h1><center>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col" class="border-0 bg-light">
                                                <div class="py-2 text-uppercase">STAFF ID</div>
                                            </th>
                                            <th scope="col" class="border-0 bg-light">
                                        ...
                                        <c:forEach var="row" items="${resultstaff.rows}">
                                            <tr>
                                                <th scope="row" class="border-0">
                                                    <div class="p-2">
                                                        <div class="ml-3 d-inline-block align-middle">
                                                            <h5 class="mb-0"><a href="#" class="text-dark d-inline-block align-middle"><c:out value="${row.STAFFID}"/></a></h5>
                                                        </div>
                                                    </div> 
                                                </th>

                                                <td class="border-0 align-middle"><strong><c:out value="${row.STAFF_EMAIL}"/></strong></td> 
                                                <td class="border-0 align-middle"><strong><c:out value="${row.STAFF_NAME}"/></strong></td>  
                                                <td class="border-0 align-middle"><a href="deleteUserStaff.jsp?userID=<c:out value="${row.STAFFID}"/>"><button type="button" class="btn btn-primary"type="submit">Delete</button></a></td>
